    ...
    if (articleContainer) {
        try {
            ...
            if (!articlesInSection) {
                ...
                sessionStorage.setItem(
                    "articles",
                    JSON.stringify(articlesInSession)
                );
            }
      ...
      */
            const currentArticleIndex =
                articlesInSection.indexOf(currentArticle);
